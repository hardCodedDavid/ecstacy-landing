...
<template>
  <main class="w-full bg-darkie px-6 md:px-12 overflow-hidden">
    <div class="py-48 2xl:py-56 max-w-desktop m-auto">
        ...
        <div class="flex flex-col lg:flex-row text-left">
          ...
          <div class="flex-[1.1] overflow-scroll lg:overflow-hidden">
            <div class="h-auto w-auto mt-8 relative">
                ...
                <img src="../assets/images/bot-1.png" class="md:w-60 sm:w-20 sm:inline md:absolute sm:relative lg:left-60 top-0 bottom-3 responsive-img" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="w-70 mx-auto mt-32 mb-32">
        <div class="flex flex-col lg:flex-row text-left">
            <div class="flex-[0.4]">
